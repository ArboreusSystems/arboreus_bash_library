...
function mSecp256k1EchoEnvironmentForAndroid_x86() {
	...
	echo "SECP256K1_PREFIX_ANDROID_X86: ${SECP256K1_PREFIX_ANDROID_X86}";
	mEchoSeparator
}

function mSecp256k1CleanForAndroid_x86() {

	mCleanDir ${SECP256K1_DIR_SOURCES};
	mCleanDir ${SECP256K1_PREFIX_ANDROID_X86};
	mEchoSeparator;
}

function mSecp256k1ConfigureForAndroid_x86() {

	source ${A_DIR_SCRIPTS}/Global/GlobalEnvironment_Android_x86.sh;
	mEchoSeparator;

	echo "Configuring Secp256k1 for Android x86.";
	cd ${SECP256K1_DIR_SOURCES};
	./autogen.sh;
	./configure \
		--host=${TARGET} \
		--prefix=${SECP256K1_PREFIX_ANDROID_X86} \
		--enable-tests=no \
		--enable-shared=no \
		--enable-static=yes \
...
mSecp256k1EchoEnvironmentForAndroid_x86;
mSecp256k1CleanForAndroid_x86;
mSecp256k1GetSources;
mSecp256k1ConfigureForAndroid_x86;
mSecp256k1Build;