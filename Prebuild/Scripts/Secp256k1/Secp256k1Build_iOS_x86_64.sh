...
function mSecp256k1EchoEnvironmentForIOS_x86_64() {
	...
	echo "SECP256K1_PREFIX_IOS_X86_64: ${SECP256K1_PREFIX_IOS_X86_64}";
	mEchoSeparator
}

function mSecp256k1CleanForIOS_x86_64() {

	mCleanDir ${SECP256K1_DIR_SOURCES};
	mCleanDir ${SECP256K1_PREFIX_IOS_X86_64};
	mEchoSeparator;
}

function mSecp256k1ConfigureForIOS_x86_64() {

	export ARCH=x86_64;
	export PREFIX=${SECP256K1_PREFIX_IOS_X86_64};
	source ${A_PREBUILT_LIBS_ROOT}/Scripts/Global/GlobalEnvironment_iOS.sh;
	mEchoSeparator;

	echo "Configuring for IOS_x86_64 build";
	cd ${SECP256K1_DIR_SOURCES};
	./autogen.sh;
	./configure \
		--host=${ARCH} \
		--prefix=${SECP256K1_PREFIX_IOS_X86_64} \
		--enable-tests=no \
		--enable-shared=no \
		--enable-static=yes \
...
mSecp256k1EchoEnvironmentForIOS_x86_64;
mSecp256k1CleanForIOS_x86_64;
mSecp256k1GetSources;
mSecp256k1ConfigureForIOS_x86_64;
mSecp256k1Build;